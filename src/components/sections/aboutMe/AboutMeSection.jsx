...
import contactInfo from "../../../sources/info/contact.json"
            ...
            <div className="aboutMe_imgs">
                ...
                <div>
                    ...
                    <a href={contactInfo.linkedin} target="_blank">
                        ...
                        <svg href={contactInfo.linkedin} viewBox="0 0 24 24" data-supported-dps="24x24" fill="currentColor" width="32" focusable="false">
